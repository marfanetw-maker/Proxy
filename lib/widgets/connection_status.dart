...
class ConnectionStatus extends StatelessWidget {
    ...
    return Consumer<V2RayProvider>(builder: (context, provider, _) {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: _getStatusColor(activeConfig != null, isConnecting).withOpacity(0.3),
              blurRadius: 10,
  ...
  List<Color> _getStatusGradient(bool isConnected, bool isConnecting) {
    if (isConnecting) {
      return [AppTheme.connectingYellow, AppTheme.connectingYellow.withOpacity(0.8)];
    }
    if (isConnected) {
      return [AppTheme.primaryGreen, AppTheme.accentGreen];
    }
    return [AppTheme.disconnectedRed, AppTheme.disconnectedRed.withOpacity(0.8)];
  }
