...
class AppInfo {
  ...
  AppInfo({required this.packageName, required this.name, required this.isSystemApp});
}
  ...
  Future<void> _saveBlockedApps() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(_selectedApps.isEmpty 
              ...
              children: [
                ...
                Expanded(
                  child: _filteredApps.isEmpty
                      ? Center(
                          child: Text(
                            _availableApps.isEmpty ? 'No apps found' : 'No matching apps',
                            style: const TextStyle(color: Colors.white),
                          ),
                        )
                      : ListView.builder(
