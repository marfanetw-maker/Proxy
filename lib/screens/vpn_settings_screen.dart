...
class _VpnSettingsScreenState extends State<VpnSettingsScreen> {
  ...
  Future<void> _loadSettings() async {
    ...
    try {
      ...
      final bool savedEnabled = prefs.getBool('bypass_subnets_enabled') ?? false;
      final bool savedDnsEnabled = prefs.getBool('custom_dns_enabled') ?? false;
      final String savedDnsServers = prefs.getString('custom_dns_servers') ?? '1.1.1.1';
  ...
  Future<void> _saveSettings() async {
    ...
    try {
      final prefs = await SharedPreferences.getInstance();
      await prefs.setString('bypass_subnets', bypassSubnetController.text.trim());
      ...
      await prefs.setString('custom_dns_servers', dnsServerController.text.trim());
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              TextButton(
                                onPressed: isEnabled ? _resetToDefaultSubnets : null,
                                child: const Text(
                                  'Reset to Default',
